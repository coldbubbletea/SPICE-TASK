...
export class ChatViewProvider implements vscode.WebviewViewProvider {
  public static readonly viewType = 'codexSciDebug.chatView';
  private view?: vscode.WebviewView;
  public onProbeDebug?: (text: string) => void;
  public onDockerVerify?: () => void;
  public onHistoryRequest?: () => RunHistoryItem[];
  public onOpenRun?: (runId: string) => void;
  public onAgentModels?: (expertModels: Record<string, string>, repairModel: string, mentorModel?: string) => void;
  public initialAgentModels?: () => {
    roles: string[];
    expertModels: Record<string, string>;
    repairModel: string;
    mentorModel?: string;
  };
  public onAgentKeys?: (expertKeys: Record<string, string>, repairKey: string, mentorKey?: string) => void;
  public initialAgentKeys?: () => {
    roles: string[];
    expertKeys: Record<string, string>;
    repairKey: string;
    mentorKey?: string;
  };
  public onKnowledgeDir?: (dir: string) => void;
  public initialKnowledgeDir?: () => string;
  ...
  resolveWebviewView(webviewView: vscode.WebviewView): void {
    ...
    webviewView.webview.onDidReceiveMessage((msg) => {
      if (msg?.type === 'send' && typeof msg.text === 'string') {
        ...
        const expertModels =
          msg.expertModels && typeof msg.expertModels === 'object'
            ? (msg.expertModels as Record<string, string>)
            : {};
        ...
        const expertKeys =
          msg.expertKeys && typeof msg.expertKeys === 'object'
            ? (msg.expertKeys as Record<string, string>)
            : {};
  ...
  public postHistory(items?: RunHistoryItem[]): void {
  ...
  public postPipelineEvent(text: string): void {
    this.view?.webview.postMessage({ type: 'backendEvent', event: { type: 'text', text: text + '\n' } });
  }

  public postPipelineUi(payload: unknown): void {
  ...
  private postEvent(event: BackendEvent): void {
